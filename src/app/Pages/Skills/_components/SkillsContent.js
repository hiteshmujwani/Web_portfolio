          ...
          <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 lg:gap-4 xl:grid-rows-2">
            ...
            >
              <GlowingEffect
                ...
                inactiveZone={0.01}
              />
              <div className="text-2xl font-sans leading-8 font-semibold dark:text-[#EEEEED]">
                Every time I feel bored, I don't scroll—I explore. From coding
                to video editing, from web design to 3D modeling, learning never
                stops.
              </div>
              <div className="text-2xl font-semibold dark:text-[#EEEEED]">
